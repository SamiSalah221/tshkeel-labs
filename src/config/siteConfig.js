export const siteConfig = {
  businessName: "Tshkeel Labs",
  tagline: "Bringing Faith to Form Through 3D Printing",
  whatsappNumber: "16024035878",
  ...
  prayerTimesIcsUrl:
    "https://prayerwebcal.dsultan.com/ics/Tempe_Tempe_AZ_USA/cs=1:es=1:fv=18.0:tz=America%2FPhoenix:x=33.426:y=-111.94",

  // Section min-heights (in viewport units)
  heroPages: 0.85,
  aboutPages: 0.6,
};
