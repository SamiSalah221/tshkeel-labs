...
export default function Footer() {
  ...
  return (
    <footer
      ...
      className="px-5 md:px-12 pt-4 md:pt-6"
      style={{ pointerEvents: 'none' }}
    >
      <div style={{ maxWidth: "var(--max-w-wide)", margin: '0 auto', pointerEvents: 'auto' }}>
        <RevealOnScroll threshold={0.1}>
        <div className="bg-bg-dark/95 backdrop-blur-md border-t border-accent/20 rounded-t-2xl px-5 md:px-8 py-10">
          {/* Gold divider */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-text-on-dark text-xs mt-1">Based in Tempe, Arizona</p>
            </div>

            {/* Quick Links */}
            <div>
              <h4 className="text-accent-light font-semibold text-sm uppercase tracking-widest mb-3">
                Quick Links
              </h4>
                ...
                {QUICK_LINKS.map((link) => (
                  <li key={link.section}>
                    <a
                      ...
                      className="text-text-on-dark hover:text-accent transition-colors text-sm cursor-pointer"
                    >
                      {link.label}
                    </a>
                  </li>
